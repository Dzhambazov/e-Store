<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="TeamChalchedony.Account.Manage" %>
        ...
        <div class="span6">
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <asp:LinkButton Text="Edit Your Profile" CssClass="btn btn-primary" OnClick="EditProfile_Click" runat="server" />
                    <fieldset class="form-horizontal">
